...
export interface TestInfrastructureManager {
   ...
   */
  initializeInfrastructure(config: TestInfrastructureConfig): Promise<InfrastructureInitializationResult>;
   ...
   */
  createTestDevice(deviceName: string, config?: TestDeviceConfig): Promise<TestDevice>;
   ...
   */
  validateInfrastructureRequirements(requirements: string[]): Promise<InfrastructureValidationResult>;
}
...
export interface TestDevice {
   ...
   */
  simulateNetworkIssues(enabled: boolean, config?: NetworkSimulationConfig): Promise<void>;
...
export interface ExerciseMockFactory {
   ...
   */
  createExerciseWithSyncStatus(syncStatus: SyncStatus, overrides?: Partial<Exercise>): Exercise;
...
export interface SyncStateMockFactory {
   ...
   */
  createSyncState(operation: SyncOperationType, status: SyncStatus, overrides?: Partial<SyncState>): SyncState;
