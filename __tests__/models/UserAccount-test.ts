...
describe('UserAccount Model', () => {
  ...
  describe('Error Classes', () => {
    ...
    it('should create AuthenticationError with code', () => {
      const error = new AuthenticationError('Auth failed', 'INVALID_CREDENTIALS');
  ...
  describe('createUserAccount', () => {
    ...
    it('should validate input before creating account', () => {
      ...
      expect(() => createUserAccount(invalidInput)).toThrow(UserValidationError);
      expect(() => createUserAccount(invalidInput)).toThrow('Anonymous users cannot have email addresses');
    });
  });
  ...
  describe('validateUserInput', () => {
    ...
    it('should reject anonymous user with email', () => {
      ...
      expect(() => validateUserInput(input)).toThrow('Anonymous users cannot have email addresses');
    });

    it('should reject authenticated user without email', () => {
      const input: UserAccountInput = { isAnonymous: false };
      
      expect(() => validateUserInput(input)).toThrow('Non-anonymous users must have email addresses');
    });
  ...
  describe('validateUserAccount', () => {
    ...
    it('should reject invalid UUID format', () => {
      ...
      expect(() => validateUserAccount(user)).toThrow('User ID must be a valid UUID');
    });

    it('should reject non-boolean isAnonymous', () => {
      const user: any = { ...validUser, isAnonymous: 'true' };
      
      expect(() => validateUserAccount(user)).toThrow('isAnonymous must be a boolean');
    });

    it('should reject anonymous user with email', () => {
      const user = { ...validUser, isAnonymous: true };
      
      expect(() => validateUserAccount(user)).toThrow('Anonymous users cannot have email addresses');
    });

    it('should reject authenticated user without email', () => {
      const user = { ...validUser, email: undefined };
      
      expect(() => validateUserAccount(user)).toThrow('Non-anonymous users must have email addresses');
    });
    ...
    it('should reject invalid createdAt', () => {
      ...
      expect(() => validateUserAccount(user)).toThrow('Invalid createdAt timestamp');
    });
    ...
    it('should reject invalid lastSyncAt', () => {
      ...
      expect(() => validateUserAccount(user)).toThrow('Invalid lastSyncAt timestamp');
    });
    ...
    it('should reject lastSyncAt before createdAt', () => {
      ...
      expect(() => validateUserAccount(user)).toThrow('lastSyncAt cannot be before createdAt');
    });
  ...
  describe('validateEmail', () => {
    ...
    it('should reject each invalid email format individually', () => {
      ...
      expect(() => validateEmail('test@domain.')).toThrow('Invalid email format');
    });
    ...
    it('should reject email that is too long', () => {
      ...
      expect(() => validateEmail(longEmail)).toThrow('Email too long (max 254 characters)');
    });
  });
  ...
  describe('validatePassword', () => {
    ...
    it('should reject long passwords', () => {
      ...
      expect(() => validatePassword(longPassword)).toThrow('Password too long (max 128 characters)');
    });

    it('should reject passwords without numbers or special characters', () => {
      expect(() => validatePassword('justletters')).toThrow('Password must contain at least one number or special character');
    });
  });
  ...
  describe('validateCredentials', () => {
    ...
    it('should reject invalid email in credentials', () => {
      ...
      expect(() => validateCredentials(credentials)).toThrow('Invalid email format');
    });
    ...
    it('should reject invalid password in credentials', () => {
      ...
      expect(() => validateCredentials(credentials)).toThrow('Password must be at least 8 characters long');
    });
  });
  ...
  describe('upgradeToAuthenticated', () => {
    it('should upgrade anonymous user to authenticated', () => {
      ...
      const upgraded = upgradeToAuthenticated(anonymousUser, 'NEW@EXAMPLE.COM  ');
    ...
    it('should reject upgrading already authenticated user', () => {
      ...
      expect(() => upgradeToAuthenticated(authenticatedUser, 'new@example.com'))
    ...
    it('should validate email during upgrade', () => {
      ...
      expect(() => upgradeToAuthenticated(anonymousUser, 'invalid-email'))
  ...
  describe('UserUtils', () => {
    ...
    describe('getSyncStatusDescription', () => {
      it('should return "Local only" for anonymous user', () => {
        ...
        expect(UserUtils.getSyncStatusDescription(user)).toBe('Local only (anonymous)');
      });
      ...
      it('should return "Synced recently" for sync within 1 hour', () => {
        ...
        expect(UserUtils.getSyncStatusDescription(user)).toBe('Synced recently');
      });
      ...
      it('should return hours for sync within 24 hours', () => {
        ...
        expect(UserUtils.getSyncStatusDescription(user)).toBe('Synced 4 hours ago');
      });
      ...
      it('should return single day for 1 day ago', () => {
        ...
        expect(UserUtils.getSyncStatusDescription(user)).toBe('Synced 1 day ago');
      });
      ...
      it('should return multiple days for more than 1 day ago', () => {
        ...
        expect(UserUtils.getSyncStatusDescription(user)).toBe('Synced 4 days ago');
      });
    });
  });
  ...
  describe('UUID Generation and Validation', () => {
    it('should generate valid UUID format for user ID', () => {
      ...
      expect(user2.id).toMatch(/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i);
