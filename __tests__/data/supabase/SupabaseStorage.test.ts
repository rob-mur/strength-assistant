...
describe("SupabaseStorage", () => {
  ...
  describe("createExercise", () => {
    ...
    it("should throw an error if exercise creation fails", async () => {
      ...
      await expect(storage.createExercise(exerciseInput)).rejects.toThrow(
        `Failed to create exercise: ${errorMessage}`,
      );
    });
  });
  ...
  describe("getExercises", () => {
    ...
    it("should throw an error if retrieval fails", async () => {
      ...
      await expect(storage.getExercises()).rejects.toThrow(
        `Failed to retrieve exercises: ${errorMessage}`,
      );
    });
  });
  ...
  describe("updateExercise", () => {
    ...
    it("should throw an error if the exercise to update is not found", async () => {
      ...
      await expect(storage.updateExercise(exerciseId, updates)).rejects.toThrow(
        "Exercise not found",
      );
    });
    ...
    it("should throw an error if the update fails", async () => {
      ...
      await expect(storage.updateExercise(exerciseId, updates)).rejects.toThrow(
        `Failed to update exercise: ${errorMessage}`,
      );
    });
  });
  ...
  describe("deleteExercise", () => {
    ...
    it.skip("should throw an error if the exercise to delete is not found", async () => {
      ...
      await expect(storage.deleteExercise(exerciseId)).rejects.toThrow(
        "Exercise not found",
      );
    });
    ...
    it.skip("should throw an error if the delete operation fails", async () => {
      ...
      await expect(storage.deleteExercise(exerciseId)).rejects.toThrow(
        `Failed to delete exercise: ${errorMessage}`,
      );
    });
  });
  ...
  describe("signInWithEmail", () => {
    it("should sign in successfully with valid credentials", async () => {
      ...
      const result = await storage.signInWithEmail(
        "test@example.com",
        "password123",
      );
    ...
    it.skip("should throw error if authentication fails", async () => {
      ...
      await expect(
        storage.signInWithEmail("test@example.com", "wrongpassword"),
    ...
    it("should throw error if no user is returned", async () => {
      ...
      await expect(
        storage.signInWithEmail("test@example.com", "password123"),
  ...
  describe("signUpWithEmail", () => {
    it("should sign up successfully with valid credentials", async () => {
      ...
      const result = await storage.signUpWithEmail(
        "test@example.com",
        "password123",
      );
    ...
    it("should throw error if sign up fails", async () => {
      ...
      await expect(
        storage.signUpWithEmail("test@example.com", "password123"),
  ...
  describe("signOut", () => {
    ...
    it("should throw error if sign out fails", async () => {
      ...
      await expect(storage.signOut()).rejects.toThrow(
  ...
  describe("getPendingSyncRecords", () => {
    it.skip("should retrieve pending sync records successfully", async () => {
      ...
      expect(mockSupabaseClient.order).toHaveBeenCalledWith("pending_since", {
        ascending: true,
      });
    });
    ...
    it("should throw error if retrieval fails", async () => {
      ...
      await expect(storage.getPendingSyncRecords()).rejects.toThrow(
        `Failed to retrieve sync records: ${errorMessage}`,
      );
    });
  });
  ...
  describe("markSyncComplete", () => {
    ...
    it("should throw error if marking sync complete fails", async () => {
      ...
      await expect(storage.markSyncComplete(recordId)).rejects.toThrow(
        `Failed to mark sync complete: ${errorMessage}`,
      );
    });
  });
  ...
  describe("markSyncError", () => {
    ...
    it.skip("should throw error if update fails", async () => {
      ...
      await expect(
        storage.markSyncError(recordId, errorMessage),
      ).rejects.toThrow("Failed to mark sync error: Update failed");
    });
  });
  ...
  describe("subscribeToExercises", () => {
    it("should subscribe to exercises changes for a user", () => {
      ...
      mockSupabaseClient.subscribe.mockReturnValueOnce({
  ...
  describe("linkEmailPassword", () => {
    it("should link email/password to anonymous user", async () => {
      ...
      const result = await storage.linkEmailPassword(
        "test@example.com",
        "password123",
      );
    ...
    it("should throw error if user is not anonymous", async () => {
      ...
      await expect(
        storage.linkEmailPassword("test@example.com", "password123"),
