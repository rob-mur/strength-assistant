...
describe("AuthScreen", () => {
  ...
  describe("Mode Switching", () => {
    it("should switch to sign up mode when button pressed", () => {
      const { getByText, getAllByText, getByTestId, queryByLabelText } =
        renderAuthScreen();
    ...
    it("should switch back to sign in mode from sign up", () => {
      const { getAllByText, getByTestId, queryByLabelText } =
        renderAuthScreen();
  ...
  describe("Form Validation", () => {
    ...
    it("should pass validation with valid inputs", () => {
      ...
      const { getByLabelText, getByTestId } = renderAuthScreen(
        createMockAuthState({
          signIn: mockSignIn,
        }),
      );
  ...
  describe("Error Handling", () => {
    it("should display error in snackbar", () => {
      ...
      const { getByTestId, getByText } = renderAuthScreen(
        createMockAuthState({
          error: mockError,
        }),
      );
    ...
    it("should handle null error gracefully", () => {
      const { queryByTestId } = renderAuthScreen(
        createMockAuthState({
          error: null,
        }),
      );
