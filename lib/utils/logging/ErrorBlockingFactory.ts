...
import { createMaestroErrorDetection, createMaestroTestHelpers } from '../testing/MaestroErrorDetection';
 ...
 */
export function createErrorBlockingFactory(config?: ErrorBlockingConfig): ErrorBlockingFactory {
  if (!globalFactory) {
