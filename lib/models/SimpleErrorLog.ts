 ...
 */
export function createSimpleErrorLog(error: Error, context: string): SimpleErrorLog {
  return {
 ...
 */
export function createSimpleErrorLogFromMessage(message: string, context: string): SimpleErrorLog {
  return {
    message,
    context,
    timestamp: new Date().toISOString(),
