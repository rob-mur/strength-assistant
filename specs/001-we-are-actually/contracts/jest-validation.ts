...
export interface JestTestValidator {
   ...
   */
  validateTestConfiguration(testConfig: TestConfiguration): Promise<TestConfigValidationResult>;
   ...
   */
  validateTestInfrastructure(testFile: string): Promise<InfrastructureValidationResult>;
...
export interface TestFailureTracker {
   ...
   */
  updateRepairStatus(testId: string, status: RepairStatus, notes?: string): Promise<TestFailureTracking>;
   ...
   */
  markTestRepaired(testId: string, validationResults: TestValidationResults): Promise<RepairCompletionStatus>;
}
...
export interface TestInfrastructureProvider {
   ...
   */
  createMockFactories(mockConfig: MockFactoryConfig): Promise<MockFactoryCollection>;
   ...
   */
  createTestDataBuilders(builderConfig: TestDataBuilderConfig): Promise<TestDataBuilderCollection>;
   ...
   */
  validateInfrastructureAvailability(requirements: string[]): Promise<InfrastructureAvailabilityResult>;
}
...
export interface ConstitutionalTestGovernance {
   ...
   */
  enforceTestRequirements(enforcementContext: EnforcementContext): Promise<EnforcementResult>;
   ...
   */
  validateTestGovernanceCompliance(complianceScope: ComplianceScope): Promise<GovernanceComplianceResult>;
   ...
   */
  reportGovernanceViolations(violations: GovernanceViolation[]): Promise<ViolationReportingResult>;
